...
public enum Rock {
	...
	COAL			("Coal", new String[]{"Coal"}, new double[]{50.0},
			true, true, new Color(24,24,17), new Color(0,0,0)),
	PAY_DIRT		("Ore vein", new String[]{"Pay-dirt"}, new double[]{60.0},
			false, false),
	...
	BANE			("Bane", new String[]{"Bane ore"}, new double[]{90.0},
			true, false),
	LIVING_ROCK_REMAINS	("Living rock remains", new String[]{"Living minerals"}, new double[]{25.0},
			true, false),
	CONCENTRATED_COAL		("Concentrated Coal", new String[]{"Coal"}, new double[]{50.0},
			true, false),
	CONCENTRATED_GOLD		("Concentrated Gold", new String[]{"Gold ore"}, new double[]{65.0},
			true, false),
	RUNITE			("Runite", new String[]{"Runite ore"}, new double[]{125.0},
			true, true, new Color(73,98,102)),
