...
import exiabots.mining.locations.special.SpecialLocation;
...
public class SpecialMiner extends MiningStyle{
	...
	private ArrayList<SpecialLocation> getLocations() {
		...
		if(ExiaMinerAIO.isRS3){
			locations.add(new exiabots.mining.locations.special.LavaFlow());
		}else{
			locations.add(new exiabots.mining.locations.special.MotherLoad());
		}
		return locations;
	}
}
